package com.minpedia.demo;

import android.support.v4.app.Fragment;

import com.minpedia.R;
import com.minpedia.demo.nosql.NoSQLSelectTableDemoFragment;
...
public class DemoConfiguration {
    ...
    static {
        ...
        addDemoFeature("engagement", R.mipmap.engage,
            ...
            , new DemoItem(R.string.main_fragment_title_user_engagement,
                R.mipmap.engage, R.string.feature_user_engaement_demo_button,
                PinpointDemoFragment.class)
        );
