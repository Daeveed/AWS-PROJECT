...
public class DemoNoSQLTableMyData extends DemoNoSQLTableBase {
    private static final String LOG_TAG = DemoNoSQLTableMyData.class.getSimpleName();
    ...
    public class DemoGetWithPartitionKey extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() throws AmazonClientException {
            ...
            result = mapper.load(MyDataDO.class, "demo-dataName-500000");
        ...
        public List<DemoNoSQLResult> getNextResultGroup() {
            ...
            results.add(new DemoNoSQLMyDataResult(result));
    ...
    public class DemoScanWithFilter extends DemoNoSQLOperationBase {
        ...
        private PaginatedScanList<MyDataDO> results;
        private Iterator<MyDataDO> resultsIterator;
        ...
        public boolean executeOperation() {
            ...
            filterExpressionAttributeNames.put("#UserId", "UserId");

            final Map<String, AttributeValue> filterExpressionAttributeValues = new HashMap<>();
            filterExpressionAttributeValues.put(":MinUserId",
                new AttributeValue().withS("demo-UserId-500000"));
            final DynamoDBScanExpression scanExpression = new DynamoDBScanExpression()
                .withFilterExpression("#UserId > :MinUserId")
                .withExpressionAttributeNames(filterExpressionAttributeNames)
                .withExpressionAttributeValues(filterExpressionAttributeValues);

            results = mapper.scan(MyDataDO.class, scanExpression);
            if (results != null) {
     ...
     */
    private static List<DemoNoSQLResult> getNextResultsGroupFromIterator(final Iterator<MyDataDO> resultsIterator) {
        if (!resultsIterator.hasNext()) {
            return null;
        }
        ...
        do {
            ...
            final MyDataDO item = resultsIterator.next();
            // Add the item to a group of results that will be displayed later.
            resultGroup.add(new DemoNoSQLMyDataResult(item));
            itemsRetrieved++;
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        final MyDataDO firstItem = new MyDataDO();

        firstItem.setDataName(
            DemoSampleDataGenerator.getRandomSampleString("dataName"));
        firstItem.setUserId(
            DemoSampleDataGenerator.getRandomSampleString("UserId"));
        firstItem.setDataDetails(
            DemoSampleDataGenerator.getRandomSampleString("dataDetails"));
        ...
        final MyDataDO[] items = new MyDataDO[SAMPLE_DATA_ENTRIES_PER_INSERT-1];
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            final MyDataDO item = new MyDataDO();
            item.setDataName(DemoSampleDataGenerator.getRandomSampleString("dataName"));
            item.setUserId(DemoSampleDataGenerator.getRandomSampleString("UserId"));
            item.setDataDetails(DemoSampleDataGenerator.getRandomSampleString("dataDetails"));
    ...
    public void removeSampleData() throws AmazonClientException {
        ...
        // colliding with DynamoDB reserved words.
        final Map <String, String> filterExpressionAttributeNames = new HashMap<>();
        filterExpressionAttributeNames.put("#hashAttribute", "dataName");
        ...
        PaginatedScanList<MyDataDO> results = mapper.scan(MyDataDO.class, scanExpression);

        Iterator<MyDataDO> resultsIterator = results.iterator();
        ...
        final List<MyDataDO> batchOfItems = new LinkedList<MyDataDO>();
